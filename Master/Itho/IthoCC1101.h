...
//message 1 commands
const uint8_t ithoMessage1FullCommandBytes[] = {1,84,213,85,50,203,52}; //Just copied these values from the commented HighCommandBytes
const uint8_t ithoMessage1HighCommandBytes[] = {1,84,213,85,50,211,52}; //{1,53,84,204,205,84,170}; //{1,84,213,85,50,203,52};
...
//message 2 commands
const uint8_t ithoMessage2FullCommandBytes[] = {6,89,150,170,165,101,90,150,85,149,101,90,102,85,150};
                                              //6,89,150,170,165,101,90,150,85,149,101,89,102,85,150
